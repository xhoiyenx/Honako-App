...
<div class="panel-actions">
  <a href="{{ route('cms.gallery.create') }}" class="btn btn-success btn-quirk">add new</a>
...
<table class="table table-custom table-hover table-cms no-margin">
  ...
  <tbody>
    ...
    <tr>
      <td>
        <a href="{{ route('cms.gallery.update', [$content->id]) }}">{{$content->name}}</a>
      </td>
      <td>
        <ul class="table-options">
          <li><a href="{{ route('cms.gallery.update', [$content->id]) }}"><i class="fa fa-pencil"></i></a></li>
          <li><a href="{{ action('App\Controller\Manager\Cms\Gallery@delete', [$content->id]) }}"><i class="fa fa-trash"></i></a></li>
        </ul>        
      </td>
    </tr>
    @endforeach
