...
<div class="panel-actions">
  <a href="{{ route('cms.team.create') }}" class="btn btn-success btn-quirk">add new</a>
...
<table class="table table-custom table-hover table-cms no-margin">
  ...
  <tbody>
    ...
    <tr>
      <td>
        <a href="{{ route('cms.team.update', [$content->id]) }}">{{$content->name}}</a>
      </td>
      <td>
        <ul class="table-options">
          <li><a href="{{ route('cms.team.update', [$content->id]) }}"><i class="fa fa-pencil"></i></a></li>
